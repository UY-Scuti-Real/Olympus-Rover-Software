...
class driver:
    def __init__(self, mode):
        ...
        #self.command_sock.set_sock_opt(s.SOL_SOCK, s.SO_REUSEADDR, 1)
        #self.command_sock.set_sock_opt(s.SOL_SOCK, s.SO_REUSEPORT, 1)
        self.command_sock.bind(("localhost", 5000))
